...
if __name__ == '__main__':
    ...
    parser.add_argument('--processes', type=int, help='number of processes to use', default=10)
    args = parser.parse_args()

    pool = multiprocessing.Pool(processes=args.processes, initializer=init_worker(),
                                initargs=(f"Worker-{os.getpid()}",))
